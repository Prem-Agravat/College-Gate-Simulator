export const checkerTracks = [
  ...
  },
  {
    ...
    speaker: "Security Guard",
    dialogue: "“ID card kya che? Bhuli gaya to chalse nahi.”",
    gujarati: "“આઈડી કાર્ડ ક્યાં છે? ભૂલી ગયા તો ચાલશે નહીં.”",
    audio: "/audio/checker/checker-03.mp3",
    image: "/images/rk_gate.jpg",
    zoomClass: "zoom-checker-backpack",
    voiceText: "ID card kya che? Bhuli gaya to chalse nahi.",
    duration: 5,
    flag: "missing",
